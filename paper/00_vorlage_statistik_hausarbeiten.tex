...
gilt [\cite{Rothe-2}]. Wobei in $(1)$ $x_1$ der grö\ss te und $x_2$ der zweitgrö\ss te Beitrag ist. In anderen Worten lässt sich sagen, dass der Tabellenwert $x$ genau dann geheimzuhalten ist, wenn die Differenz zwischen $x$ und $x1_1$, $x_2$ nicht mindestens $p\%$ vom grö\ss ten Beitrag $x_1$ beträgt.

Um letztlich auch die Geheimhaltung durchzuführen wird unter diesen Regeln oft auf das Verfahren der \textit{Zellsperrung} zurückgegriffen [\cite{Rothe-1}].
